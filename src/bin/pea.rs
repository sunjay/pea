...
struct Options {
    ...
    /// Print an annotated version of the program with the generated bytecode instructions
    #[structopt(long = "print-annotated-bytecode")]
    pub print_annotated_bytecode: bool,
}
...
fn main() {
    ...
    if print_annotated_bytecode {
        ...
        println!();
        interpreter.print_all_annotated_bytecode();
    }
